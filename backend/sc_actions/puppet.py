...
from backend.sc_actions.ip import get_ip_all, get_or_create_ip
from backend.sc_actions.os import get_or_create_os
from backend.sc_database.model.Puppets import Puppets
